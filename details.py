...
class DetailsRoom:
    ...
    # Title
        Label_title=Label(self.root,text='Room Adding Department',font=('times new roman ',20,'bold'),bg="#052403",fg="gold",bd=4,relief=RIDGE)
        ...
        # lable frame
        labelframeleft=LabelFrame(self.root,border=2,relief=RIDGE,text="New Room Add",padx=2,font=('times new roman ',12,'bold'))
        ...
        entry_floor=ttk.Entry(labelframeleft,width=20,textvariable=self.var_floor,font=("arial",13,"bold"))   
        ...
        entry_RoomNo=ttk.Entry(labelframeleft,width=20,textvariable=self.var_roomNo,font=("arial",13,"bold"))   
        ...
        entry_RoomType=ttk.Entry(labelframeleft,width=20,textvariable=self.var_RoomType,font=("arial",13,"bold"))   
    ...
    def get_cuersor(self,event):
        ...
        content=self.room_table.item(cusrsor_row)  #cusrsor_row is a variable
        row=content["values"]
    ...
    def add_data(self):
        if self.var_floor.get()=="" or self.var_RoomType.get()=="":
                ...
                try:
                        ...
                        data=(self.var_floor.get(), self.var_roomNo.get(),self.var_RoomType.get())
...
# ========================Update ROOM=====================
    ...
    def update(self):
        if self.var_floor.get()=="":
                ...
                data=(self.var_floor.get(),self.var_RoomType.get(),self.var_roomNo.get())
                my_cursor.execute(sql,data)
                conn.commit()
                self.fetch_data()
                conn.close()
